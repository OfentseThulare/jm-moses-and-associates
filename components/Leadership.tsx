...
export const Leadership: React.FC = () => {
  ...
  return (
    <section id="leadership" className="py-16 sm:py-24 lg:py-32 bg-brand-offWhite overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <div className="absolute -inset-4 sm:-inset-6 border-2 border-brand-red/10 rounded-lg z-0"></div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-brand-charcoal mb-2">Built on expertise. Driven by integrity.</h2>
            <p className="text-lg sm:text-xl text-brand-grey mb-8 sm:mb-10 font-medium italic">Founded by Julian Moses CA(SA)</p>

            <div className="space-y-4 sm:space-y-6 text-brand-grey text-base sm:text-lg leading-relaxed mb-8 sm:mb-12">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 mb-8 sm:mb-12">
              <div>
                <h3 className="font-serif text-xl sm:text-2xl font-bold text-brand-charcoal mb-4 sm:mb-6 border-b border-brand-border pb-3">Our Values</h3>
              ...
              <div>
                <h3 className="font-serif text-xl sm:text-2xl font-bold text-brand-charcoal mb-4 sm:mb-6 border-b border-brand-border pb-3">Credentials</h3>
                <ul className="space-y-4">
