...
export const Assessment: React.FC = () => {
  ...
  return (
    <section id="assessment" className="py-32 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <span className="text-brand-red font-bold tracking-[0.2em] uppercase text-xs mb-4 block">Assessment Tool</span>
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-charcoal mb-6">Compliance Readiness Score</h2>
        ...
        <div className="bg-[#F9F9F9] rounded-xl p-8 md:p-16 transition-all shadow-sm border border-brand-border">
          ...
          {view === 'intro' && (
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h3 className="text-3xl font-serif font-bold mb-6">Are your numbers decision-ready?</h3>
              <p className="text-brand-grey text-lg mb-10 leading-relaxed">This 2-minute assessment will highlight key areas of risk in your financial governance and compliance status.</p>
          ...
          {view === 'questions' && (
            <div>
              ...
              <h3 className="text-3xl md:text-4xl font-serif font-bold mb-12 text-brand-charcoal leading-tight">
              ...
              <div className="grid grid-cols-1 gap-4">
                {questions[currentQuestionIndex].options.map((option, idx) => (
                  <button
                    ...
                    className="w-full text-left px-8 py-6 bg-white border-2 border-transparent rounded-lg hover:border-brand-red hover:shadow-xl transition-all duration-300 flex justify-between items-center group"
                  >
                    <span className="text-brand-charcoal font-bold text-lg group-hover:text-brand-red">{option.label}</span>
          ...
          {view === 'capture' && (
            <div className="max-w-md mx-auto">
              <h3 className="text-3xl font-serif font-bold text-center mb-6">Assessment Complete</h3>
          ...
          {view === 'results' && (
            <div className="text-center">
              ...
              <h3 className="text-4xl font-serif font-bold text-brand-charcoal mb-4">{result.level}</h3>
              <p className="text-brand-grey text-lg mb-12 max-w-xl mx-auto">{result.desc}</p>
              
              <div className="text-left bg-white p-10 rounded-lg border border-brand-border mb-12 shadow-sm">
                ...
                <ul className="space-y-4">
                  {result.recommendations.map((rec, i) => (
                    <li key={i} className="flex items-start">
                      ...
                      <span className="text-brand-charcoal font-medium text-lg">{rec}</span>
                    </li>
                  ))}
                </ul>
              </div>
